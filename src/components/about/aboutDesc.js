...
function AboutDesc() {
  return (
    ...
    <div className='aboutDesc'>
        ...
        <div className="aboutText">
            ...
            <div className='downloadResume'>
                <button>
                    <a href='https://drive.google.com/file/d/170M_3U2DVNkaiA7pisBOrnHyzbmZjScL/view?usp=drivesdk' target="_blank" rel="noreferrer">
                        Resume
                    </a>
                </button>
            </div>
    ...
    <div className="aboutSlider">
        <ContactCard link='https://share.google/TNBuqyjhovsMQ0gGl' site='R.K College of Nursing' points={['Final Year B.Sc. Student', '2021-2025', '3x 3-Months Trainee']} />
